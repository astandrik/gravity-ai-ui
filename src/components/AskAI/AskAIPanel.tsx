...
export function AskAIPanel({
  ...
  const subject = label.includes("this interface")
    ? "this interface"
    : "Gravity AI UI";
  ...
  return (
    <Card
      view={minimal ? "clear" : "raised"}
      className={`ask-ai-panel${compact ? " ask-ai-panel_compact" : ""}${minimal ? " ask-ai-panel_minimal" : ""}`}
    >
      <div className="ask-ai-panel__content">
        {!minimal && (
          <div className="ask-ai-panel__body">
            <Text
              as={compact ? "p" : "h2"}
              variant={compact ? "body-1" : "subheader-2"}
              className="ask-ai-panel__title"
            >
              {label}
            </Text>
            <Text
              as="p"
              variant={compact ? "caption-2" : "body-1"}
              color="secondary"
              className="ask-ai-panel__help"
            >
              {helperText}
            </Text>
          </div>
...
function GoogleAIModeMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" focusable="false" {...props}>
      <path
        fill="currentColor"
        d="M12 1.25l1.1 4.1a7.6 7.6 0 005.55 5.55l4.1 1.1-4.1 1.1a7.6 7.6 0 00-5.55 5.55l-1.1 4.1-1.1-4.1a7.6 7.6 0 00-5.55-5.55L1.25 12l4.1-1.1A7.6 7.6 0 0010.9 5.35L12 1.25z"
      />
    </svg>
  );
}
