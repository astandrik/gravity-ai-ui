...
const page = getComparisonPage("gravity-ai-ui-vs-uizard");
...
export default function GravityAiUiVsUizardPage() {
  return <ComparisonArticle slug="gravity-ai-ui-vs-uizard" />;
}
