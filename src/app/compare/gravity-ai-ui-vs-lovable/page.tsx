...
const page = getComparisonPage("gravity-ai-ui-vs-lovable");
...
export default function GravityAiUiVsLovablePage() {
  return <ComparisonArticle slug="gravity-ai-ui-vs-lovable" />;
}
